...
catalogo = Catalogo(host='jadh4.mysql.pythonanywhere-services.com', user='jadh4', password='ana18125',database='jadh4$miapp')

#carpeta para guardar las imagenes
#ruta_destino = './static/img/'
ruta_destino = '/home/jadh4/mysite/Static/img/'
